...
export default function Carpet({navigation}) {
  ...
  const [carpet, setCarpet] = useState([
    {
      ...
      "service9": "Small(25-50 square feet)",
      "price": " ₹599"
    },
    {
      id: "2",
      ...
      "service7": "Drying",
      "service8" : "Please allow the sofa to dry completely for 4 - 5 hours under the fan .",
      "service9": "Medium(50-100 square feet)",
      "price": " ₹799"
    },
    {
      id: "3",
      ...
      "service7": "Drying",
      "service8" : "Please allow the sofa to dry completely for 4 - 5 hours under the fan .",
      "service9": "Large (100 to 150 square feet) ",
      "price": " ₹949"
    },
    {
      id: "4",
      ...
      "service7": "Drying",
      "service8" : "Please allow the sofa to dry completely for 4 - 5 hours under the fan .",
      "service9": 'Extra large (150 to 200 square feet )',
      "price": " ₹1099"
    },
  ...
  return (
    ...
    <View className=" flex flex-row bg-white shadow-gray-300 shadow-2xl justify-between py-2">
              ...
              <View>
    <Image className=" h-64" source={require('../assets/carpet.jpg')}/>
    </View>
