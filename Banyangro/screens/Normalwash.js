...
export default function Normalwash({navigation}) {
  return (
    <SafeAreaProvider className=" flex-1 bg-[#F9F9F9]">
      <View className=" flex flex-col">
        ...
        <View>
        <Image className=" h-64" source={require('../assets/wash.jpg')}/>
        </View>

        <View className=" mt-2 flex flex-col bg-white">
          <View className="flex flex-row justify-between mx-3">
          <Text className=" text-black text-xl font-extrabold mx-0 pt-2"> Normal Car Wash</Text>

          <Text className=" text-green-600 font-semibold text-base font-Inter pt-[5px] mr-3">60% off</Text>
                ...
                <View className=" flex flex-row justify-between mx-4">
                  <View className=" flex flex-col pb-4">
                    <Text className=" text-black font-bold text-base">Time: 40min</Text>
  ...
  <View className="flex flex-row w-full mt-2">
     <Text className=" text-black font-extrabold text-xl">Price: </Text>
                   <Text className="font-medium text-sm mt-[8px] text-red-800 text-center line-through">₹625</Text>
