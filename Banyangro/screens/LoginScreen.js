    ...
    <SafeAreaView className=" flex-1 bg-white">
      ...
      <View className=" flex flex-col">
        ...
        <TextInput
          ...
          returnKeyType="next"
        />
        <TouchableOpacity className=" flex justify-end items-end mx-8" onPress={()=> navigation.navigate('ForgotPassword')}>
        ...
        <View className=" flex flex-row justify-center items-center">
          <Text className=" text-sm font-normal text-black font-Inter">
